...
namespace Izume.Mobile.Odeo.Common.Logging
{
	/// <summary>
	...
	{
		const string DefaultPrefix  = "__";
		const int RetentionCount = 2; // Number of logs to keep when housekeeping
		...
		public static void Reset()
		{
			...
			Delete();
			WriteLine("Log file reset under program control");
		}
